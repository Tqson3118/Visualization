...
| 2142 | Auth | GoogleLogin action (useAuthStore) | goi statelessAuthApi.googleLogin -> _applyStatelessAuth | PASSED |
| 2143 | Courses | published roadmaps list | teacherStudioService.getPublishedRoadmaps map name/nodes/tags | PASSED |
| 2144 | Courses | roadmap detail + node list | getRoadmap -> mapRoadmapToCourseDetail | PASSED |
| 2145 | Lesson viz | LessonVisualizer scoped DSA | selectAlgorithm + executeDSAAlgorithm + mini VCR | PASSED |
| 2146 | Lesson viz | ConceptVisualizer oop/solid | render encapsulation/inheritance/... scene | PASSED |
| 2147 | Lesson viz | LessonStepViz fullscreen | Teleport overlay + nut Dong | PASSED |
| 2148 | Teacher | visualizerConfig save/load | RoadmapEditor form -> updateNodeContent | PASSED |
| 2149 | Seed | visualizerConfig moi node | DbSeeder + teacher_roadmaps.json | PASSED |

### Code-to-Viz step (LessonStudyView) - 2026-08-06
| 2150 | CodeWorkspace | optional props initialCode/initialArray | set store tai setup (truoc Monaco mount) + watch prop change -> set + chay moi; /code-ide khong doi | PASSED |
| 2151 | CodeWorkspace | preserveAnimation | khong clear animStore khi mount trong lesson (giu viz step); /code-ide van clear nhu cu | PASSED |
| 2152 | Templates | normalizeArrayAlgorithmKey | alias bubble/quick/merge/heap/linear/binary/sliding/sorting => key; graph/bfs/bst/stack/oop/solid => null | PASSED |
| 2153 | Templates | getCodeVizTemplate | 12 key deu co code+array >= 2; sampleInput hop le uu tien hon default | PASSED |
| 2154 | Templates | end-to-end AST+sandbox | 9 sort template sort dung + co COMPARE/SWAP frames; search/sliding chay khong loi | PASSED |
| 2155 | Gate | build + vitest | FE build (vue-tsc + vite) xanh; vitest 843/843 PASS (64 files) | PASSED |