<template>
  <div class="checkout-container flex items-center justify-center h-full px-4 py-8">
      ...
      <div class="col-span-12 md:col-span-7 p-8 flex flex-col justify-center min-h-[480px]">
        ...
        <template v-else>
          ...
          <div v-else-if="paymentStore.checkoutState === 'verifying'" class="text-center py-12">
            ...
            <p class="text-sm text-[var(--color-text-secondary)]">Đang xác nhận thanh toán...</p>
          </div>
...
.main-card { border-color: var(--color-border-default); box-shadow: 0 0 50px -15px rgba(6,182,212,0.15); }
