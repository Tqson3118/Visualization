  ...
  <section class="tab-section fade-in">
    ...
    <div class="dashboard-tables">
      ...
      <div class="card card--logs">
        <h3 class="card-heading"><BaseIcon name="clipboard-list" style="width:18px;height:18px" /> Nhật ký hệ thống mới nhất <span class="ml-2 px-2 py-0.5 rounded-md bg-accent-warm/20 text-accent-warm text-[10px] font-bold uppercase tracking-wider">Demo</span></h3>
