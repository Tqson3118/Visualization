  ...
  <div class="custom-input-panel backdrop-blur-md rounded-2xl p-4 shadow-xl flex flex-col gap-3.5 border border-border-subtle bg-bg-secondary/65 max-h-full overflow-hidden">
    ...
    <div v-else class="flex flex-col gap-2">
      <textarea
        ...
        rows="3"
        class="import-textarea w-full border rounded-xl p-2.5 text-xs font-mono text-text-primary outline-none transition-all resize-none bg-bg-secondary border-border-subtle focus:border-accent-cyan"
      ></textarea>
    ...
    <div class="border-t border-border-subtle pt-3 flex flex-col gap-2 bg-bg-surface pb-1 shrink-0">
