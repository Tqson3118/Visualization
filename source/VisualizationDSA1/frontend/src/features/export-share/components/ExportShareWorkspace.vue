    ...
    <div class="workspace-content">
      <div class="workspace-header">
        <h2 class="workspace-title">
          ...
          <span class="ml-2 px-2 py-0.5 rounded-md bg-accent-warm/20 text-accent-warm text-[10px] font-bold uppercase tracking-wider align-middle">Demo</span>
        </h2>
        ...
        <p class="text-[11px] text-text-muted mt-1">
          Sơ đồ bên dưới là dữ liệu mẫu minh hoạ — chưa nối state thật của visualizer.
        </p>
      </div>
