...
// Đồng bộ editor khi sourceCode bị thay đổi từ bên ngoài (prop initialCode/đổi bài).
// Khi user gõ, store.sourceCode luôn bằng editor content → không trigger setValue lại.
watch(
  () => compilerStore.sourceCode,
  (newCode) => {
