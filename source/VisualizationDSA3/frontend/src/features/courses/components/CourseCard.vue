      ...
      <div class="flex items-center justify-between pt-3 border-t border-border-subtle">
        ...
        <div class="flex items-center gap-3">
          ...
          <router-link
            ...
            :class="(!isEnrolled) ? 'bg-bg-surface border border-border-default hover:bg-bg-hover text-white shadow-none' : (progressPercent === 100 ? 'bg-accent-green hover:bg-accent-green text-white shadow-accent-green/30' : 'bg-accent hover:bg-accent text-white shadow-accent/30')"
          >
