// features/algorithm-sandbox/helpers/catalogKeyMap.ts — D6: map SortAlgorithm ↔ catalog key sort.*
// Chỉ map 6 thuật toán ĐÃ CÓ key catalog (shared/simulation-catalog.json + engines/catalog.ts).
// radix / counting / bucket CHƯA có key catalog — backlog D6 (KHÔNG tự thêm key vì CI so 44 key).
