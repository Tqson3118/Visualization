...
export const CATALOG: CatalogMeta[] = [
  ...
  { key: 'graph.dijkstra', title: 'Đồ thị — Dijkstra (đường đi ngắn nhất)', dataStructure: 'Đồ thị', category: 'algorithm', level: 'advanced', complexity: { best: 'O(V²)', average: 'O(V²)', worst: 'O(V²)', space: 'O(V)' }, tags: ['đồ thị', 'Dijkstra', 'quét tuyến tính'], demoAllowed: false },
  ...
  { key: 'structure.hashtable', title: 'Bảng băm (Hash Table — Xử lý va chạm: Chuỗi nối kết)', dataStructure: 'Bảng băm', category: 'structure', level: 'basic', complexity: { best: 'O(1)', average: 'O(1)', worst: 'O(n)', space: 'O(n)' }, tags: ['CTDL', 'bảng băm'], demoAllowed: false },
