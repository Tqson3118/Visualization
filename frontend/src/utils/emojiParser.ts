// Bê NGUYÊN từ source/VisualizationDSA1/frontend/src/utils/emojiParser.ts (V1)
// Phần "simulator/control" bổ sung ở task 2 (ControlBar/Toast/BottomSheet/ConfirmModal dùng BaseIcon).
export const SVG_PATHS: Record<string, string> = {
  // ── Simulator / VCR controls (task 2) ──
  'step-backward': '<line x1="19" y1="5" x2="19" y2="19"/><polygon points="17 12 5 19 5 5 17 12"/>',
  'step-forward': '<line x1="5" y1="5" x2="5" y2="19"/><polygon points="7 12 19 19 19 5 7 12"/>',
